# 🎵 Chinook Database SQL Analysis | End-to-End Data Analyst Project

> This project demonstrates end-to-end SQL data analysis on the Chinook database, covering customer behavior, sales performance, and business insights.
...
* Rock is the most popular genre by both sales volume and revenue.
* The United States is the highest revenue-generating country.
* No single track dominates sales; multiple tracks share top positions.
* Sales remain stable over time with occasional spikes.
...
* Advanced SQL querying (joins, aggregations, window functions)
